...
**BombSquad Game Servers**  
- Modified and hosted multiplayer game servers using Python  
- Deployed and managed servers on AWS EC2  
- Worked with live environments, server stability, and Linux-based hosting  

**Discord Automation (2022)**  
- Built and operated a large-scale Discord bot  
- Implemented server monitoring, join-gate systems, and moderation tooling  
- Managed real-world usage for a small but active community  

**Backend APIs**  
- Designed REST APIs with Flask and FastAPI  
- Integrated SQLite and MongoDB backends  
- Deployed services using Render, Vercel, and custom Linux servers  
